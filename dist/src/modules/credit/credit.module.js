...
exports.CreditModule = CreditModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([credit_entity_1.Credit, user_entity_1.User, debit_entity_1.Debit])],
        controllers: [credit_controller_1.CreditController],
        providers: [credit_service_1.CreditService, jwt_service_1.JWTUtil],
    })
], CreditModule);
